...
/// @title Uniswap V3 Swap Router // SafePermit
    ...
    Ownable
{
    ...
    // only associate tokens with this function call
    function associateSwapRouterToToken(address token) external onlyOwner {
